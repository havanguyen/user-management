...
/**
 * Consumer for processing registration messages from RabbitMQ
 */
@Service
...
public class RegistrationMessageConsumer {
    ...
    public void processRegistration(RegistrationMessage message) {
        ...
        try {
            ...
            // TODO: Gửi notification về kết quả thất bại cho sinh viên

        } catch (Exception e) {
            log.error("Unexpected error processing registration: requestId={}", message.getRequestId(), e);
            throw e; // Re-throw để RabbitMQ retry hoặc đưa vào DLQ
        }
    }
    ...
    private void handleRegister(RegistrationMessage message) {
        ...
        // TODO: Gửi notification về kết quả đăng ký thành công
    }

    private void handleDrop(RegistrationMessage message) {
        // Tìm enrollment để lấy enrollmentId
        ...
        // TODO: Gửi notification về kết quả hủy đăng ký
    }
}
